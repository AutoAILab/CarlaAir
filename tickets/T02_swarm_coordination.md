...
## Tasks
- [x] **Swarm Configuration**
    - [x] Update `settings.json` with 5 drone definitions (`UAV_1` to `UAV_5`).
- [x] **Chase Behavior**
    - [x] Implement UGV "Chase" mode for the entire swarm.
    - [x] **Perspective Offsets**: Assign fixed height/pitch per drone (15m, 30m, 45m, 60m, 90m).
- [x] **Movement Stability**
    - [x] Ensure smooth transform application during Replay.
