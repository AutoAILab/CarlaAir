...
- [x] **Schema Implementation**
    - [x] Define OpenLabel 1.0.0 JSON header and metadata structures.
- [x] **Real-time Logging**
    - [x] Implement per-frame appending to `master_manifest.jsonl`.
    - [x] **Swarm Tagging**: Implement multi-drone tagging (`UAV_1` to `UAV_5`) per image stream.
    - [x] Autogenerate ODD tags (`Weather`, `Town`).
